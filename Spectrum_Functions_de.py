...
def gen_spectrum_1dip(center,width,peak,wl=wl, base=0): # center and width in nm
...
def gen_spectrum_1gauss(center,width,peak,wl=wl,base=0): # center and width in nm
...
def gen_spectrum_2dip(center1,width1,peak1=1,center2=600,width2=100,peak2=1,wl=wl,base=0): # center and width in nm
...
def gen_spectrum_2gauss(center1,width1,peak1=1,center2=600,width2=100,peak2=1,wl=wl,base=0): # center and width in nm
