...
from color_cell_optimization import spec_to_XYZ, load_cmf, plot_outcome, getPmax
...
light_source = LightSource(
    source_type="black body", x=wavelengths*1e9, output_units="photon_flux_per_nm", entendue="Sun", T=5778)
...
for rad_eff in [0.01, 0.1, 1]:
    ...
    for i1, eg in enumerate(Egs):
        ...
        eff[i1] = getPmax([eg], photon_flux_cell[1], wavelengths*1e9, interval, rad_eff)
...
struct = tmm_structure([ARC_layer] + DBR_layers_2 + DBR_layers, incidence=Air, transmission=Si)
