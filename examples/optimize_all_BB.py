...
force_rerun = True # if True, will not load previous results but re-run and replace existing results
force_rerun_ideal = True # if True, will re-calculate black cell optimal bandgaps (used to determine bounds for
