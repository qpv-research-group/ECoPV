import optimize_pipeline_1J as op
...
if __name__ == '__main__':
    ...
    eff_result = np.empty((len(color_names),3))
    ...
    for i in range(len(color_lab)):
        ...
        eff_result[i, :] = [loop_res.one_peak_eff, loop_res.two_peak_eff, loop_res.Eg]
    ...
    eff_result.to_csv("non_fixed_peak_result.csv")
